...
import 'package:goldfarm/pages/partner_register_sub/service/farmer_sub_register_service.dart';
...
class FarmerRegisterSub extends StatefulWidget {
  final String uid;

  const FarmerRegisterSub({Key key, this.uid}) : super(key: key);

  @override
  _FarmerRegisterSubState createState() => _FarmerRegisterSubState();
}

class _FarmerRegisterSubState extends State<FarmerRegisterSub> {
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                            ...
                            children: <Widget>[
                              Flexible(
                                child: new TextField(
                                  ...
                                  decoration: InputDecoration(
                                      labelText: AppLocalizations.of(context).translate("latitude")?? Const.latitude),
                                ),
                              ),
                              SizedBox(
                                width: 10,
                              ...
                              Flexible(
                                child: new TextField(
                                  ...
                                  decoration: InputDecoration(
                                      labelText: AppLocalizations.of(context).translate("Longitude")?? Const.Longitude),
                                ),
                              ),
                            ],
                          ),
                          ...
                          TextField(
                            ...
                            decoration:
                                InputDecoration(labelText: AppLocalizations.of(context).translate("taluka")?? Const.taluka),
                          ),
                          TextField(
                            controller: _villageController,
                            decoration:
                                InputDecoration(labelText: AppLocalizations.of(context).translate("village")?? Const.village),
                          ),
                        ],
                      ),
                    ),
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          if (_latitudeController.text == '') {
                            ...
                            FarmerSubRegisterService.updateFarmer(
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      FarmerKycUpload(fid: widget.uid)),
                            );
                          }
                        },
                        child: Text(
